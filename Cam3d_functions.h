...
DLL_EXPORT_C int stereoMatch(const double *points3dData, const double *points2dData, int numPoints,
                             double *cameraMatrix, double *distCoeffs,
                             double *rotationMatrix, double *translationVector);
DLL_EXPORT_C int project3DPointsColorPosition(double *points3dData, int numPoints,
                                              double *cameraMatrix, double *distCoeffs,
                                              double *rotationMatrix, double *translationVector,
                                              double *points2dData);
